...
```mermaid
graph TB
    subgraph Wallet["Wallet Pan"]
        ID["ID: pan_wallet_abc123"]
        Address["Address: 0x742d35Cc..."]
        User["User ID: usuario_maria_123"]
    end
