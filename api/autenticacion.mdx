...
fetch('https://api.pan.com/api/v1/yields', {
  headers: {
...
```python Python
requests.get(
    'https://api.pan.com/api/v1/yields',
...
| Endpoint | X402 |
|----------|------|
| GET /api/v1/wallets/:userId | Si |
| GET /api/v1/balances/:walletId | Si |
| GET /api/v1/yields | Si |
| GET /api/v1/intents/:intentId | Si |
| POST /api/v1/wallets | No |
| POST /api/v1/intents | No |
