...
<AccordionGroup>
  ...
  <Accordion title="¿Puedo elegir en qué chain depositar?">
    pan optimiza automáticamente la chain considerando:
    - Donde están tus fondos actualmente
    - Costos de bridge vs. beneficio de APY
    - Liquidez disponible

    El sistema elige la mejor opción para minimizar costos y maximizar rendimiento.
  </Accordion>

  <Accordion title="¿Qué pasa si depósito en Ethereum y quiero mover a Arbitrum?">
    pan maneja esto automaticamente. Si tus fondos están en Ethereum, pan:
